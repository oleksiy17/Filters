    ...
    uint32_t    sample_rate)
{
    ...
    init_coeffs->comp_ch_1_coef._rep_ratio = 0.0;
    init_coeffs->comp_ch_1_coef.alphaAttack = 0.0;
    init_coeffs->comp_ch_1_coef.alphaRelease = 0.0;
    init_coeffs->comp_ch_1_coef._one_g_att = 0.0;
    init_coeffs->comp_ch_1_coef._one_g_rel = 0.0;
    ...
    init_coeffs->comp_ch_1_coef._one_env_att = 0.0;
    init_coeffs->comp_ch_1_coef._one_env_rel = 0.0;
    ...
    init_coeffs->comp_ch_2_coef._rep_ratio = 0.0;
    init_coeffs->comp_ch_2_coef.alphaAttack = 0.0;
    init_coeffs->comp_ch_2_coef.alphaRelease = 0.0;
    init_coeffs->comp_ch_2_coef._one_g_att = 0.0;
    init_coeffs->comp_ch_2_coef._one_g_rel = 0.0;
    ...
    init_coeffs->comp_ch_2_coef._one_env_att = 0.0;
    init_coeffs->comp_ch_2_coef._one_env_rel = 0.0;
    ...
    init_coeffs->comp_ch_3_coef._rep_ratio = 0.0;
    init_coeffs->comp_ch_3_coef.alphaAttack = 0.0;
    init_coeffs->comp_ch_3_coef.alphaRelease = 0.0;
    init_coeffs->comp_ch_3_coef._one_g_att = 0.0;
    init_coeffs->comp_ch_3_coef._one_g_rel = 0.0;
    ...
    init_coeffs->comp_ch_3_coef._one_env_att = 0.0;
    init_coeffs->comp_ch_3_coef._one_env_rel = 0.0;
    ...
    init_coeffs->comp_ch_4_coef._rep_ratio = 0.0;
    init_coeffs->comp_ch_4_coef.alphaAttack = 0.0;
    init_coeffs->comp_ch_4_coef.alphaRelease = 0.0;
    init_coeffs->comp_ch_4_coef._one_g_att = 0.0;
    init_coeffs->comp_ch_4_coef._one_g_rel = 0.0;
    ...
    init_coeffs->comp_ch_4_coef._one_env_att = 0.0;
    init_coeffs->comp_ch_4_coef._one_env_rel = 0.0;
    ...
    void*       coeffs)
{
    ...
    update_coeffs->comp_ch_1_coef.alphaAttack = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_1_par.tauAttack*update_params->comp_ch_1_par.samplerate)));
    update_coeffs->comp_ch_1_coef.alphaRelease = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_1_par.tauRelease*update_params->comp_ch_1_par.samplerate)));

    update_coeffs->comp_ch_1_coef.attackEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_1_par.tauEnvAtt*update_params->comp_ch_1_par.samplerate)));
    update_coeffs->comp_ch_1_coef.releaseEnv = powf(M_e, (-1.0 / (0.001*update_params->comp_ch_1_par.tauEnvRel*update_params->comp_ch_1_par.samplerate)));
    ...
    update_coeffs->comp_ch_1_coef._rep_ratio  = 1.0 - (1.0 / update_coeffs->comp_ch_1_coef.ratio);
    update_coeffs->comp_ch_1_coef._one_g_att = 1.0 - update_coeffs->comp_ch_1_coef.alphaAttack;
    update_coeffs->comp_ch_1_coef._one_g_rel = 1.0 - update_coeffs->comp_ch_1_coef.alphaRelease;
    update_coeffs->comp_ch_1_coef._one_env_att = 1.0 - update_coeffs->comp_ch_1_coef.attackEnv;
    update_coeffs->comp_ch_1_coef._one_env_rel = 1.0 - update_coeffs->comp_ch_1_coef.releaseEnv;
    ...
    update_coeffs->comp_ch_2_coef._rep_ratio = 1.0 - (1.0 / update_coeffs->comp_ch_2_coef.ratio);
    update_coeffs->comp_ch_2_coef._one_g_att = 1.0 - update_coeffs->comp_ch_2_coef.alphaAttack;
    update_coeffs->comp_ch_2_coef._one_g_rel = 1.0 - update_coeffs->comp_ch_2_coef.alphaRelease;
    update_coeffs->comp_ch_2_coef._one_env_att = 1.0 - update_coeffs->comp_ch_2_coef.attackEnv;
    update_coeffs->comp_ch_2_coef._one_env_rel = 1.0 - update_coeffs->comp_ch_2_coef.releaseEnv;
    ...
    update_coeffs->comp_ch_3_coef._rep_ratio = 1.0 - (1.0 / update_coeffs->comp_ch_3_coef.ratio);
    update_coeffs->comp_ch_3_coef._one_g_att = 1.0 - update_coeffs->comp_ch_3_coef.alphaAttack;
    update_coeffs->comp_ch_3_coef._one_g_rel = 1.0 - update_coeffs->comp_ch_3_coef.alphaRelease;
    update_coeffs->comp_ch_3_coef._one_env_att = 1.0 - update_coeffs->comp_ch_3_coef.attackEnv;
    update_coeffs->comp_ch_3_coef._one_env_rel = 1.0 - update_coeffs->comp_ch_3_coef.releaseEnv;
    ...
    update_coeffs->comp_ch_4_coef._rep_ratio = 1.0 - (1.0 / update_coeffs->comp_ch_4_coef.ratio);
    update_coeffs->comp_ch_4_coef._one_g_att = 1.0 - update_coeffs->comp_ch_4_coef.alphaAttack;
    update_coeffs->comp_ch_4_coef._one_g_rel = 1.0 - update_coeffs->comp_ch_4_coef.alphaRelease;
    update_coeffs->comp_ch_4_coef._one_env_att = 1.0 - update_coeffs->comp_ch_4_coef.attackEnv;
    update_coeffs->comp_ch_4_coef._one_env_rel = 1.0 - update_coeffs->comp_ch_4_coef.releaseEnv;
}
