    ...
    void*       coeffs)
{
    ...
    update_coeffs->a0 = 1.0 + alpha;
    update_coeffs->a1 = (-2.0) * cosf(omega);
    update_coeffs->a2 = 1.0 - alpha;

    update_coeffs->b0 = 1.0;
    update_coeffs->b1 = (-2.0) * cosf(omega);
    update_coeffs->b2 = 1.0;
